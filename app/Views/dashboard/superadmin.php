...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-header">
            ...
            <p class="sidebar-subtitle">Super Admin</p>
        </div>
        ...
        <nav class="sidebar-menu">
            ...
            <a href="<?= base_url('dashboard/tsanawiyyah') ?>" class="menu-item">
                ...
                <span>Tsanawiyyah</span>
            </a>
            <a href="<?= base_url('dashboard/muallimin') ?>" class="menu-item">
                <i class="icofont-graduate-alt"></i>
                <span>Mu'allimin</span>
            </a>

            <div class="menu-label">Export Data</div>
            <a href="<?= base_url('dashboard/export/csv') ?>" class="menu-item">
                <i class="icofont-file-text"></i>
                <span>Export Semua (CSV)</span>
            </a>
            <a href="<?= base_url('dashboard/export/excel') ?>" class="menu-item">
    ...
    <main class="main-content">
        ...
        <header class="top-navbar">
            <div style="display: flex; align-items: center; gap: 15px;">
                ...
                <h2 class="navbar-title">Dashboard Admin</h2>
            </div>
        ...
        <div class="content-area">
            ...
            <div class="stats-grid animate__animated animate__fadeIn">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <h3><?= number_format($stats['tsanawiyyah']) ?></h3>
                        <p>Tsanawiyyah</p>
                    </div>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <h3><?= number_format($stats['muallimin']) ?></h3>
                        <p>Mu'allimin</p>
                    </div>
                </div>
            ...
            <div class="table-card animate__animated animate__fadeInUp">
                <div class="table-header">
                    <h3 class="table-title">Semua Data Pendaftar</h3>
                    <div class="table-actions">
                        ...
                        <a href="<?= base_url('dashboard/export/csv') ?>" class="btn-export csv">
                            <i class="icofont-file-text"></i> CSV
                        </a>
                        <a href="<?= base_url('dashboard/export/excel') ?>" class="btn-export excel">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge <?= $p['jalur_pendaftaran'] === 'TSANAWIYYAH' ? 'badge-tsanawiyyah' : 'badge-muallimin' ?>">
                                                <?= esc($p['jalur_pendaftaran']) ?>
                                            </span>
                                        </td>
