...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="<?= base_url('dashboard/tsanawiyyah') ?>" class="menu-item active">
            ...
            <a href="<?= base_url('dashboard/export/csv') ?>?jalur=TSANAWIYYAH" class="menu-item">
                <i class="icofont-file-text"></i>
                <span>Export CSV</span>
            </a>
            <a href="<?= base_url('dashboard/export/excel') ?>?jalur=TSANAWIYYAH" class="menu-item">
    ...
    <main class="main-content">
        ...
        <header class="top-navbar">
            <div style="display: flex; align-items: center; gap: 15px;">
                ...
                <h2 class="navbar-title">Dashboard Tsanawiyyah</h2>
            </div>
        ...
        <div class="content-area">
            ...
            <div class="table-card animate__animated animate__fadeInUp">
                <div class="table-header">
                    <h3 class="table-title">Data Pendaftar Tsanawiyyah</h3>
                    <div class="table-actions">
                        ...
                        <a href="<?= base_url('dashboard/export/csv') ?>?jalur=TSANAWIYYAH" class="btn-export csv">
                            <i class="icofont-file-text"></i> CSV
                        </a>
                        <a href="<?= base_url('dashboard/export/excel') ?>?jalur=TSANAWIYYAH" class="btn-export excel">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('Tsanawiyyah dashboard initialized');
        });
    </script>
