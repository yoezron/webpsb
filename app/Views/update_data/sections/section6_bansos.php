    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-3">
            ...
            <input type="text" class="form-control numeric-only" id="no_kks" name="no_kks"
                value="<?= old('no_kks', $bansos['no_kks'] ?? '') ?>" placeholder="Masukkan nomor KKS" maxlength="30">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control numeric-only" id="no_pkh" name="no_pkh"
                value="<?= old('no_pkh', $bansos['no_pkh'] ?? '') ?>" placeholder="Masukkan nomor PKH" maxlength="30">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control numeric-only" id="no_kip" name="no_kip"
                value="<?= old('no_kip', $bansos['no_kip'] ?? '') ?>" placeholder="Masukkan nomor KIP" maxlength="30">
