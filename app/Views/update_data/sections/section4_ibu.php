...
<div class="section-card hidden" id="section-4">
    <h2 class="section-title">
        <i class="icofont-girl"></i> Data Ibu
    </h2>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control numeric-only" id="nik_ibu" name="nik_ibu"
                value="<?= old('nik_ibu', $ibu['nik_ibu'] ?? '') ?>" placeholder="Masukkan NIK ibu" maxlength="16">
        </div>
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="pekerjaan_ibu" name="pekerjaan_ibu"
                value="<?= old('pekerjaan_ibu', $ibu['pekerjaan_ibu'] ?? '') ?>" placeholder="Masukkan pekerjaan ibu">
        </div>
        ...
        <div class="col-md-6 mb-3">
            ...
            <select class="form-select" id="penghasilan_ibu" name="penghasilan_ibu">
                ...
                <option value="< 1 juta" <?= old('penghasilan_ibu', $ibu['penghasilan_ibu'] ?? '') === '< 1 juta' ? 'selected' : '' ?>>< 1 juta</option>
                <option value="1-2 juta" <?= old('penghasilan_ibu', $ibu['penghasilan_ibu'] ?? '') === '1-2 juta' ? 'selected' : '' ?>>1-2 juta</option>
                <option value="2-3 juta" <?= old('penghasilan_ibu', $ibu['penghasilan_ibu'] ?? '') === '2-3 juta' ? 'selected' : '' ?>>2-3 juta</option>
                <option value="3-5 juta" <?= old('penghasilan_ibu', $ibu['penghasilan_ibu'] ?? '') === '3-5 juta' ? 'selected' : '' ?>>3-5 juta</option>
                <option value="5-10 juta" <?= old('penghasilan_ibu', $ibu['penghasilan_ibu'] ?? '') === '5-10 juta' ? 'selected' : '' ?>>5-10 juta</option>
                <option value="> 10 juta" <?= old('penghasilan_ibu', $ibu['penghasilan_ibu'] ?? '') === '> 10 juta' ? 'selected' : '' ?>>> 10 juta</option>
                <option value="Tidak Berpenghasilan" <?= old('penghasilan_ibu', $ibu['penghasilan_ibu'] ?? '') === 'Tidak Berpenghasilan' ? 'selected' : '' ?>>Tidak Berpenghasilan</option>
            </select>
        </div>

        <!-- No HP Ibu -->
        <div class="col-md-6 mb-3">
            <label for="hp_ibu" class="form-label required">No. HP/WhatsApp</label>
            <input type="text" class="form-control numeric-only" id="hp_ibu" name="hp_ibu"
                value="<?= old('hp_ibu', $ibu['hp_ibu'] ?? '') ?>" placeholder="Masukkan no. HP ibu" maxlength="20" required>
        </div>

        <!-- Alamat Ibu -->
        <div class="col-md-12 mb-3">
            <label for="alamat_ibu" class="form-label">Alamat (jika berbeda dengan anak)</label>
            <textarea class="form-control" id="alamat_ibu" name="alamat_ibu" rows="2"
                placeholder="Kosongkan jika sama dengan alamat anak"><?= old('alamat_ibu', $ibu['alamat_ibu'] ?? '') ?></textarea>
        </div>
    </div>
</div>
